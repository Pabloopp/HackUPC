...
HD_PWD='/home/pablo/Documents/HackUPC/2d_hw_acc/2d_hw_acc.runs/design_1_conv_ip_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_conv_ip_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_conv_ip_1_0.tcl
